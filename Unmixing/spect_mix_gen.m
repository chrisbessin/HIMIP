function [y,x,noise,sigma,outliers] = spect_mix_gen(M,samp_size,varargin)
%%
% Usage:
...
%                'Diri_id'   -> Dirichelet with equal parameters
%                'Diri_mix'  -> Mixture of Dirichlet densities
%
%                Default = 'uniform'
%
...
%                      pdf_pars = A; [m,p+1] ;
%                      Each line of A contains the parameters of a 
%                      Dirichlet mode. 
