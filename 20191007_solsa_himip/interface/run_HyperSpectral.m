function run_HyperSpectral(varargin) %CoreScan_Experiment_uuid,Fusion_Experiment_uuid,CoreScan_Config_ID,HyperSpectral_Config_ID,DB_URI,CoreScan_Table_Name,Fusion_Table_Name,HyperSpectral_Experiment_uuid,check)
%{
...
% TODO, install curl and add certificates 
